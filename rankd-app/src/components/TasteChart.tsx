...
import { MOVED, type TasteAxis, type TasteShape } from "@/lib/taste";
...
export function TasteChart({ axes, was }: { axes: TasteAxis[]; was?: TasteShape }) {
  const n = axes.length;
  ...
  return (
    ...
    >
      ...
      <g fontSize="9.5" fill="var(--dim)" letterSpacing="0.06em">
        {axes.map((a, i) => {
